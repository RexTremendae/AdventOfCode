...
namespace _2019_IntcodeComputer
{
    public interface IConnector
    {
        long Output(int? requesterId = null);
        void ReceiveInput(long input, int? requesterId = null);
    ...
    public class Computer
    {
        ...
        private int _maxInstructionCount;
        ...
        public long? RequestInput()
        {
            ...
            if (_connector?.RequestTermination ?? false)
            {
        ...
        public InstructionEntity GetInstruction(long index)
        {
            ...
            var entity = (InstructionEntity)((Instruction)instruction switch
            {
                ...
                _ => throw new InvalidOperationException($"Invalid instruction: {_memory.Read(index)} at position {index}. " + _memory.ToString())
            });
