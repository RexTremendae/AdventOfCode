...
namespace Day13
{
    public class Program
    {
        ...
        public void Run(string[] args)
        {
            ...
            //WriteLine(solver.Solve(10, new Point(7,4)));
            WriteLine(solver.Solve(1358, new Point(31,39)));
        }
    }
    ...
    public class Solver
    {
        ...
        public int Solve(int seed, Point goal)
        {
            _seed = seed;

            EnqueuePossibleMoves(new Point(1, 1), new List<Point>());
