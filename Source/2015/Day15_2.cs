...
namespace Day15
{
    public class Program
    {
        ...
        public void Run(string[] args)
        {
            ...
            WriteLine("---------------------------");
            WriteLine(FindOptimalCookie(_sugar, _sprinkles, _candy, _chocolate).ToString());
            WriteLine("---------------------------");
            ...
            for (int i = 0; i <= 100; i ++)
            {
                for (int j = 0; j <= 100 - i; j ++)
                {
                    for (int k = 0; k <= 100 - i - j; k ++)
                    {
                        ...
                        if (cookie.Calories == 500 && score > maxCookie.CalculateScore()) maxCookie = cookie;
                    }
                }
            }
    ...
    public class Cookie
    {
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(GetRecipe());
            sb.AppendLine();
            sb.AppendLine("Calories: " + Calories);
            sb.AppendLine("Score: " + CalculateScore().ToString("### ### ### ###"));
