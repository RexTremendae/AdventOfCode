...
namespace Day5
{
    public class Program
    {
        ...
        public void Run()
        {
            ...
            var computer = new Computer(instructions: instructions, input: 1);
            computer.Run();
        }
    }
    ...
    public class Computer
    {
        ...
        public Computer(List<long> instructions, long input)
        {
            _input = input;
            _instructions = new List<long>(instructions);
        }

        public void Run(long? noun = null, long? verb = null)
        {
            ...
            while(entity.Instruction != Instruction.Terminate)
            {
                ...
                entity.Execute();
                //WriteLine($"Executing {entity.Instruction}");
                index += entity.Size;
            }
        }
        ...
        public InstructionEntity GetInstruction(List<long> instructions, int index)
        {
            ...
            var entity = (InstructionEntity)((Instruction)instruction switch {
                ...
                _ => throw new InvalidOperationException($"Invalid instruction: {instructions[index]}")
            });
