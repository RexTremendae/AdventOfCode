...
fn main() {
    ...
    all_lines.sort();
    let mut _guard_id = -1;
    let mut _total_sleep:HashMap<i32,i32> = HashMap::new();
    ...
    for line in all_lines
    {
        ...
        else if parts[2] == "wakes"
        {
            ...
            *_total_sleep.entry(_guard_id).or_insert(0) += _min-_sleep_start;
    ...
    for minute in 0..60
    {
        match _sleep_minutes.get(&(max_id, minute))
        {
            Some(count) =>
            {
                if *count > max_count
